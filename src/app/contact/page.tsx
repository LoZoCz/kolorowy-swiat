...
export default function Contact() {
    const submitForm = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        toastNoti({ message: 'Wiadomość wysłana', type: 'success' })
    }
    ...
    return (
        <Main>
            <section
                ...
                className="relative space-y-6 p-4 pt-[3vw]"
            >
            ...
            <div className="absolute left-0 top-0 h-full w-full bg-neutral-content/50"></div>
        </Main>
    )
}
